...
class RPC_Request_Callback : public Callback<void, JsonVariantConst const &> {
  public:
    ...
    RPC_Request_Callback(char const * const methodName, function received_callback, JsonArray const * const parameters = nullptr, uint64_t const & timeout_microseconds = 0U, Callback_Watchdog::function timeout_callback = nullptr);
