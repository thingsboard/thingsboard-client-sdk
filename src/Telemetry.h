...
class Telemetry {
  public:
    ...
    /// @brief Serializes a key-value pair or only a value, depending on the constructor used
    /// @tparam TSource Source class that the given key-value pair or only a value, should be copied into
