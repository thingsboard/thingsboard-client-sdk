...
/// @tparam MaxRPC Maximum amount of key-value pairs that will ever be sent in the subscribed callback method of an @ref RPC_Callback, allows to use a StaticJsonDocument on the stack in the background.
