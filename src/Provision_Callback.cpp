...
Provision_Callback::Provision_Callback(Access_Token, function callback, char const * const provision_device_key, char const * const provision_device_secret, char const * const device_name, uint64_t const & timeout_microseconds, Callback_Watchdog::function timeout_callback)
  : Callback(callback)
...
Provision_Callback::Provision_Callback(Device_Access_Token, function callback, char const * const provision_device_key, char const * const provision_device_secret, char const * const access_token, char const * const device_name, uint64_t const & timeout_microseconds, Callback_Watchdog::function timeout_callback)
  : Callback(callback)
  , m_device_key(provision_device_key)
  , m_device_secret(provision_device_secret)
  , m_device_name(device_name)
...
Provision_Callback::Provision_Callback(Basic_MQTT_Credentials, function callback, char const * const provision_device_key, char const * const provision_device_secret, char const * const username, char const * const password, char const * const client_id, char const * const device_name, uint64_t const & timeout_microseconds, Callback_Watchdog::function timeout_callback)
  : Callback(callback)
  , m_device_key(provision_device_key)
  , m_device_secret(provision_device_secret)
  , m_device_name(device_name)
...
Provision_Callback::Provision_Callback(X509_Certificate, function callback, char const * const provision_device_key, char const * const provision_device_secret, char const * const hash, char const * const device_name, uint64_t const & timeout_microseconds, Callback_Watchdog::function timeout_callback)
  : Callback(callback)
  , m_device_key(provision_device_key)
  , m_device_secret(provision_device_secret)
  , m_device_name(device_name)
...
void Provision_Callback::Set_Device_Key(char const * const provision_device_key) {
    m_device_key = provision_device_key;
}
...
void Provision_Callback::Set_Device_Secret(char const * const provision_device_secret) {
    m_device_secret = provision_device_secret;
}
...
void Provision_Callback::Set_Device_Name(char const * const device_name) {
    m_device_name = device_name;
}
...
void Provision_Callback::Set_Device_Access_Token(char const * const access_token) {
    m_access_token = access_token;
}
...
void Provision_Callback::Set_Credentials_Client_ID(char const * const client_id) {
    m_cred_client_id = client_id;
}
