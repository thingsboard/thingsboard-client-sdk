...
class Provision_Callback {
  public:
    ...
    inline Provision_Callback()
      : Provision_Callback(nullptr, nullptr, nullptr) {  }
    ...
    inline Provision_Callback(processFn cb, const char *provisionDeviceKey, const char *provisionDeviceSecret, const char *deviceName = nullptr)
    ...
    /// @param deviceName Name the created device should have on the cloud,
    /// pass nullptr or an empty string if the access token should be used as a name instead
    inline Provision_Callback(processFn cb, const char *provisionDeviceKey, const char *provisionDeviceSecret, const char *accessToken, const char *deviceName = nullptr)
    ...
    /// @param deviceName Name the created device should have on the cloud,
    /// pass nullptr or an empty string if the access token should be used as a name instead
    inline Provision_Callback(processFn cb, const char *provisionDeviceKey, const char *provisionDeviceSecret, const char *username, const char *password, const char *clientID, const char *deviceName = nullptr)
    ...
    /// @param deviceName Name the created device should have on the cloud,
    /// pass nullptr or an empty string if the access token should be used as a name instead
    inline Provision_Callback(processFn cb, const char *provisionDeviceKey, const char *provisionDeviceSecret, const char *hash, const char *deviceName = nullptr)
