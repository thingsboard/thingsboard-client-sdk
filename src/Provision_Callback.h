...
// allows the same paramter types to be passed without causing overload resolution issues.
struct Access_Token{};
...
class Provision_Callback : public Callback<void, JsonDocument const &> {
  public:
    ...
    /// @param client_id Basic MQTT credentials client ID, that will be used by the provisioned device
    /// @param hash Public X.509 certificate hash, that will be used by the provisioned device
    /// @param device_name Name the created device should have on the cloud, pass nullptr or an empty string if a random string generated by the server should be used as the name.
