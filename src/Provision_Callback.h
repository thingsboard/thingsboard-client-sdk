...
class Provision_Callback : public Callback<void, JsonDocument const &> {
  public:
    ...
    Provision_Callback(Access_Token, function callback, char const * const provision_device_key, char const * const provision_device_secret, char const * const device_name = nullptr);
    ...
    /// @param device_name Name the created device should have on the cloud,
    /// pass nullptr or an empty string if a random string should be used as a name instead
    Provision_Callback(Device_Access_Token, function callback, char const * const provision_device_key, char const * const provision_device_secret, char const * const access_token, char const * const device_name = nullptr);
    ...
    /// @param device_name Name the created device should have on the cloud,
    /// pass nullptr or an empty string if a random string should be used as a name instead
    Provision_Callback(Basic_MQTT_Credentials, function callback, char const * const provision_device_key, char const * const provision_device_secret, char const * const username, char const * const password, char const * const client_id, char const * const device_name = nullptr);
    ...
    /// @param device_name Name the created device should have on the cloud,
    /// pass nullptr or an empty string if a random string should be used as a name instead
    Provision_Callback(X509_Certificate, function callback, char const * const provision_device_key, char const * const provision_device_secret, char const * const hash, char const * const device_name = nullptr);
