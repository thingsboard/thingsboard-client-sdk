...
class ThingsBoardSized {
  public:
    ...
    /// alternatively setting THINGSBOARD_ENABLE_STREAM_UTILS to 1 allows to send arbitrary size payloads if that is done the internal buffer of the PubSubClient
